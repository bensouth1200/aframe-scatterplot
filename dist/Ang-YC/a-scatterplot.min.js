...
AFRAME.registerComponent('dataplot', {
    schema: {
        ...
        //Content key
        content: {default: 'content', type: 'string'},
...
function setupHighlight(el, particleSystem) {
    ...
    function makeTextSprite(text, relPosition, absPosition) {
        ...
        // Dynamic scale
        var scale = sprite.position.distanceTo(camera.getWorldPosition()) / ((window.innerWidth / textCanvas.width)*10);
    ...
    function render() {
        ...
        if (intersects.length > 0) {
            ...
            //var textString = particleSystem.geometry.userData.Content[highlighted.index];
    ...
    d3.json(data.src, function(json) {
        ...
        function splitAndParse(dat) {
            ...
            return dat.map(function(part) {
                if(!parseFloat(part.trim(), 10).isNaN){
        ...
        var material;
        var geometry;
        var testString = new String("This is a Test");
        ...
        if (data.s || data.userSpecifiedPointsprite) {
            ...
            var cTexts = new Float32Array( json.length );
            new Array
            ...
            for ( var i = 0, i3 = 0; i < json.length; i ++, i3 += 3 ) {
                ...
                //cTexts[i] = stats.content(json[i][data.content]);
                //console.log(cTexts[i]);
            ...
            geometry.userData ={ Content: "This is a test" };
            ...
            json.forEach(function(point){
                ...
                // geometry.userData.push(testString)
            })
